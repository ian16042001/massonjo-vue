<template>
    ...
    <section class="container py-6">
      ...
      <h1 class="text-3xl md:text-3xl font-extrabold leading-tight text-center pt-3 text-primary">PLOMBIER CHAUFFAGISTE À ARTHAZ-PONT-NOTRE-DAME</h1>
  ...
  <HeroSection city="Arthaz-Pont-Notre-Dame" />
