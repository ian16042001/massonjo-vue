<template>
    ...
    <section class="container py-6">
      ...
      <h1 class="text-3xl md:text-3xl font-extrabold leading-tight text-center pt-3 text-primary">PLOMBIER CHAUFFAGISTE À CONTAMINE-SUR-ARVE</h1>
  ...
  <HeroSection city="Contamine-sur-Arve" />
